...
- \"/c \"\"\"\"%\~f0\"\" \"\"%\~1\"\" \_\_elevated\_\_\"\"\" - parameters for cmd.exe. It is string whits inner quotes. /c - Carries out the command specified by string and then terminates. Next is the **command** in double quotes (that the way of vbs escapes characters):<br>
